...
<body>
    ...
    <nav class="bottom-nav">
        <div class="nav-container">
            <a href="subscription.html" class="nav-item active" data-page="subscription">
                <i class="fas fa-envelope-open-text"></i>
                <span>Subscription</span>
            </a>
            <a href="deals.html" class="nav-item" data-page="deals">
                <i class="fas fa-tag"></i>
                <span>Deals</span>
            </a>
            <a href="filter.html" class="nav-item" data-page="filter">
                <i class="fas fa-filter"></i>
                <span>Filter & Sort</span>
            </a>
            <a href="bookings.html" class="nav-item" data-page="bookings">
                <i class="fas fa-calendar-alt"></i>
                <span>Bookings</span>
            </a>
            <a href="city.html" class="nav-item" data-page="city">
